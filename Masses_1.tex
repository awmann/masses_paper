...
\begin{itemize}
\item The fit behaves poorly near the edges of the calibration sample (\mks$\gtrsim11.0$ and \mks$\lesssim4.0$). The scatter in the MCMC posterior accounts for this, but restrict use to $4.0<M_{K_S}<11.0$ ($0.07M_\odot<M_*<0.70M_\odot$), and a `safe' range would be $4.5<M_{K_S}<10.5$ ($0.08M_\odot<M_*<0.68M_\odot$). 
