...
After the completion of our observing program, we removed targets with fewer than six independent astrometric measurements and those lacking a precise parallax ($\sigma_{\pi}<8\%$). We attempted to fit orbits of the remaining 68 systems (Section~\ref{sec:orbit}). 
%%AWM edit this needs some 

Nine of the orbits fits failed to converge, mostly because their semi-major axes were much larger than expected (e.g., eccentric systems caught near periapsis). An additional seven were removed because the derived mass for the system was too imprecise ($>$20\% errors on $M_{tot}$) to be useful. This left us with 52 binaries (104 stars).
