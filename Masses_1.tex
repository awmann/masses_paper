...
I
%% to do:
%% fit the high-mass range and low-mass range separately (to see if F is different)
...
\end{eqnarray}
We did not explore higher-order terms in metallicity, as the models were reasonably well-fit with a linear term.
...
%AWM edit; this possibly needs to be heavily revised based on the results of the linear term test
...
%% need to think about how to explain this with the f and g term
